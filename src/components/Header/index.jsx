  ...
  return (
    <div className="h-[100vh] w-[16rem] fixed top-0 left-0 text-white bg-blue-950 flex flex-col items-center shadow-md gap-6">
      ...
      <div className="flex flex-col gap-3 text-xl">
        <Link to="/" className = "hover:bg-blue-900 w-[15vw] px-3 py-1 rounded-md transition-all hover:scale-90 duration-300" onClick={() => setTab("/")}>
          {tab === "/" ? <Home /> : <HomeOutlined />}
          <Button style={{ color: "white" }}>Home</Button>
        </Link>
        <Link to="/new-post" className = "hover:bg-blue-900 w-[15vw] px-3 py-1 rounded-md transition-all hover:scale-90 duration-300" onClick={() => setTab("/new-post")}>
          {tab === "/new-post" ? <AddCircle /> : <AddCircleOutline />}
          <Button style={{ color: "white" }}>Create</Button>
        </Link>
        <Link to="/search" className = "hover:bg-blue-900 w-[15vw] px-3 py-1 rounded-md transition-all hover:scale-90 duration-300" onClick={() => setTab("/search")}>
